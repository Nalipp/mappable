...
- Use `data-ingestion-process.md` for the durable discover → validate → finalize workflow and file ownership rules.
- Use the active `../../data-collection-*.instructions.md` profile for the dataset-specific scope and validation order.
